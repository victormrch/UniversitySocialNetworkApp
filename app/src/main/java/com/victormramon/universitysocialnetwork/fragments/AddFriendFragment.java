...
import com.victormramon.universitysocialnetwork.recyclerview.friendsuggested.FriendSuggestedRecyclerAdapter;
...
public class AddFriendFragment extends Fragment {
    ...
    private void prepare(View v) {
        ...
        FriendSuggestedRecyclerAdapter rvAdapter = new FriendSuggestedRecyclerAdapter
    ...
    private void getBundleFromArgument() {
        this.suggestion = (Sugerencias) this.getArguments()
                .getSerializable(getString(R.string.key_friendSuggestion));
